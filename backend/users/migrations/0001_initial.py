    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('father_name', models.CharField(help_text='Введите отчетство пользователя', max_length=254, verbose_name='Отчество')),
                ('phone_number', models.CharField(help_text='Введите номер телефона в формате +7 (111) 111-11-11', max_length=50, verbose_name='Номер телефона')),
